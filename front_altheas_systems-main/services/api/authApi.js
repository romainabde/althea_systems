...
/**
 * Inscription alignée sur auth-cart-service : body { fullName, email, password }.
 * Pas de session : confirmer l’e-mail puis POST /api/auth/confirm-email ou page /auth/confirm.
 */
export async function registerWithCredentials({ fullName, email, password }) {
